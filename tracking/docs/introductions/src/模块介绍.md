...
![Boosting_Training](/home/jerry/Documents/works/tracking/docs/pictures/Boosting_Training.png)
...
```python
#生成Booting追踪器
retval = cv.TrackerBoosting_create()
...
```python
#生成MedianFlow追踪器
retval = cv.TrackerMedianFlow_create()
